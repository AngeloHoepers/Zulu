...
@WebServlet("/ConsultaRankingMaior")
public class ConsultaRankingMaior extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ConsultaRankingMaior() {
        super();
    }
    ...
    private void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	usuarios = jdbcUsuario.buscarRankingMaior();
    	conec.fecharConexao();
